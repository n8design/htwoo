...
<Meta title="Components/Dialogs/HOODialogHeader" component={HOODialogHeader}/>
...
<Canvas>
  <Story 
    name="IconName"
    args = { 
      { title: "Dialog Header Example - IconName", closeIconName: "hoo-icon-close" }
    }>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story 
    name="IconSVG"
    args = { 
      { title: "Dialog Header Example - IconSVG", closeIconSVG: iconSVG }
    }>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story 
    name="Extending"
    args = { 
     { title: "Dialog Header Example - Extending", closeIconName: "hoo-icon-close", rootElementAttributes: { style: { backgroundColor: "pink" } }}
    }>
    {Template.bind({})}
  </Story>
</Canvas>