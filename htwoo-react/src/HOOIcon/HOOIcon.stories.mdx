...
<Meta title="Components/Icons/HOOIcon" component={HOOIcon} />
...
<Canvas>
  <Story
    ...
    args={
      (function(){
        symset.initSymbols();
        return { iconName: 'hoo-icon-close', title: 'Click to close the dialog.' };
      })()
    }>
    {Template.bind({})}
  </Story>
...
<Canvas>
  <Story
    ...
    args={
      (function(){
        symset.initSymbols();
        return { iconName: 'hoo-icon-close', rootElementAttributes: { style: { color: "red" } } };
      })()      
    }>
    {Template.bind({})}
  </Story>
