...
>As of HTWOO version 2.1.x all dialogs are not rendered using the HTML Dialog element and therefore this guidance is not needed. Dialogs can be rendered inline and will overlay the page properly.
