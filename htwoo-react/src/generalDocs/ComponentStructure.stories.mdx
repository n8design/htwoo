...
1. Via the `rootElementAttributes` you can add additional classes to the component. If you do so your classes will be appended to the class list *AFTER* the HTWOO classes.
