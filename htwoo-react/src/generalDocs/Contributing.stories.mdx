...
1. Create an index.ts file in the same parent folder to export classes and types that will be neccessary for the use of the component. This allows for selective imports.
1. Add a reference to your components folder in the `index.ts` file (try to maintain alphabetical order) to include the component in the global import.
