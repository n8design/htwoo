...
/**
 * Complete release script for htwoo-core ecosystem
 * Handles version sync, package building, testing, and publishing
 */

class HtwooReleaseManager {
  constructor() {
  ...
  runTests() {
    ...
    // Run styleguide build test
    this.exec('npm run build:package');
    
    // Run core package tests
    this.exec('npm test', { cwd: this.corePackagePath });
  ...
  generateChangelog() {
    ...
    this.exec('npm run changelog:htwoo-core');
...
// CLI Interface
const releaseManager = new HtwooReleaseManager();
