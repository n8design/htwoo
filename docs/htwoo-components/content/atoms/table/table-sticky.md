...
To support multiple columns make sure you include the [table.js](/components/../js/table/) in your code. From the htwoo-core package `node_modules/htwoo-core/lib/js/table`.
