...
description: "A specialized input field for selecting both a date and time in a single control."
type: "components"
layout: "single"
patternId: "atoms-input-input-datetime-local"
category: "atoms"
subcategory: "input"
seoTitle: "Atoms - Input Input Datetime Local"
seoDescription: "Input Input Datetime Local Atoms"
weight: 15.3
hasVariants: false
markup: |
