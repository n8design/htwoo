...
description: "A responsive grid layout for displaying quick links as button elements without outline borders. Features clean, minimal button styling optimized for subtle navigation and secondary actions."
type: "components"
layout: "single"
patternId: "organism-quick-links-grid-quick-links-button-no-outline-grid"
category: "organism"
subcategory: "quick-links-grid"
seoTitle: "Organism - Quick Links Grid Quick Links Button No Outline Grid"
seoDescription: "Quick Links Grid Quick Links Button No Outline Grid Organism"
weight: 30
hasVariants: false
markup: |
