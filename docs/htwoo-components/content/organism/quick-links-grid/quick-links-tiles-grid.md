...
description: "A responsive grid layout for displaying quick links as visual tiles with prominent images. Features large, touch-friendly tiles with customizable image sizes, optimized for visual navigation and app l"
type: "components"
layout: "single"
patternId: "organism-quick-links-grid-quick-links-tiles-grid"
category: "organism"
subcategory: "quick-links-grid"
seoTitle: "Organism - Quick Links Grid Quick Links Tiles Grid"
seoDescription: "Quick Links Grid Quick Links Tiles Grid Organism"
weight: 20
hasVariants: false
markup: |
