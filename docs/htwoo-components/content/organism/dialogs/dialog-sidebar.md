...
variants:
  - id: "organism-dialogs-dialog-sidebar-left"
    title: "Sidebar Left"
    variantName: "left"
    markup: |
      ...
      &lt;/dialog&gt;
      &lt;!--- ⬇️ Script below is just for demo purposes ⬇️ --&gt;
          &lt;script&gt;let dlg = document.querySelector(&#39;#dlgsbleft&#39;);
  ...
  - id: "organism-dialogs-dialog-sidebar-right"
    title: "Sidebar Right"
    variantName: "right"
    markup: |
      ...
      &lt;/dialog&gt;
      &lt;!--- ⬇️ Script below is just for demo purposes ⬇️ --&gt;
          &lt;script&gt;let dlg = document.querySelector(&#39;#dlgsbright&#39;);
