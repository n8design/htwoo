...
description: "A button-style quick link with outline border, centered content layout, and support for both icon and description text. This variant provides professional appearance with centered alignment for balanc"
type: "components"
layout: "single"
patternId: "molecules-quick-links-ql-list-button-outline-center"
category: "molecules"
subcategory: "quick-links"
seoTitle: "Molecules - Quick Links Ql List Button Outline Center"
seoDescription: "Quick Links Ql List Button Outline Center Molecules"
weight: 50
hasVariants: false
markup: |
